...
public class ItemRecordForge extends Item
{
    /** The name of the record. */
    public final String recordName;
    public final String recordData;

    public ItemRecordForge(int par1, String par2Str, String par3Str)
    {
        super(par1);
        this.recordName = par2Str;
        this.recordData = par3Str;
        this.maxStackSize = 1;
    }
    ...
    {
        par2List.add("Zelda - " + this.recordName);
    }
