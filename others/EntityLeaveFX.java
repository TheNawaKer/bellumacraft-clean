...
public class EntityLeaveFX extends EntityFX
{
    float smokeParticleScale;

    public EntityLeaveFX(World var1, double var2, double var4, double var6, double var8, double var10, double var12)
    {
        this(var1, var2, var4, var6, var8, var10, var12, 1.0F);
    }

    public EntityLeaveFX(World var1, double var2, double var4, double var6, double var8, double var10, double var12, float var14)
    {
